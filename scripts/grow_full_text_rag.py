...
def main(argv: list[str] | None = None) -> int:
    ...
    payload = {
        ...
        "full_text": {
            ...
            "native_downloaded": harvest.native_downloaded,
            "native_already_downloaded": harvest.native_already_downloaded,
            "native_deferred": harvest.native_deferred,
            "native_failed": harvest.native_failed,
