"""SQLite table rebuild adding truthful durable chat progress steps."""
...
def add_chat_progress_steps(connection: sqlite3.Connection) -> None:
    ...
    connection.executescript(
        ...
        ALTER TABLE job_events RENAME TO job_events_v28;
        ALTER TABLE jobs RENAME TO jobs_v28;
        ...
        INSERT INTO jobs SELECT * FROM jobs_v28;
        ...
        INSERT INTO job_events SELECT * FROM job_events_v28;
        DROP TABLE job_events_v28;
        DROP TABLE jobs_v28;
