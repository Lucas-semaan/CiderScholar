...
from app.services.workflows import (
    bibliographic_database_filter_options,
    browse_bibliographic_database,
    harvested_bibliographic_statistics,
)
...
def library_summary(
    ...
    return {
        "statistics": harvested_bibliographic_statistics(database),
        "filters": bibliographic_database_filter_options(database),
    }
...
def library_records(
    ...
    return browse_bibliographic_database(
        database,
        query=query,
