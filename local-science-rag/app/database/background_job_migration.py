"""SQLite table rebuild adding queued synthesis and private-ingestion work."""
...
def add_background_job_contracts(connection: sqlite3.Connection) -> None:
    """Extend the closed type/step constraints without losing queued work."""
    ...
    connection.executescript(
        ...
        ALTER TABLE job_events RENAME TO job_events_v24;
        ALTER TABLE jobs RENAME TO jobs_v24;
        ...
        CREATE TABLE jobs (
            ...
            type TEXT NOT NULL CHECK(
                type IN (
                    ...
                    'long_synthesis', 'private_ingestion'
                )
            ),
        ...
        INSERT INTO jobs SELECT * FROM jobs_v24;
        ...
        INSERT INTO job_events SELECT * FROM job_events_v24;
        DROP TABLE job_events_v24;
        DROP TABLE jobs_v24;
